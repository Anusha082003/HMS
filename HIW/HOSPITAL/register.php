...
<body>
    ...
    <!--<nav class="navbar navbar-expand-lg bg-light">
                    ...
                    <a class="navbar-brand" href="index.html">HIW</a>
        ...
        <div class="container-fluid">
          <h1 class="navbar-brand" style="padding-left:2%;">HIW | Registration</h1>
     ...
     <!--<h3 class="header" style="padding-left:30%;padding-top:2%;">HIW | Registration</h3>-->
